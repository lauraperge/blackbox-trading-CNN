...
\textbf{As a real world application:}
Model creation:

- different combinations, further tuning, state-of-the art CNN
...
- if resources allow at least 50-100 model tests to map out apprx. distribution of results and correct the bias

- more assets, for different economic regimes
